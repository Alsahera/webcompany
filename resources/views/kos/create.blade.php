...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item active">Tambah Kos</li>
@endsection
        ...
        <div class="admin-card">
            <div class="admin-card-header">
                <div class="admin-card-title">
                    <i class="bi bi-house-add text-primary"></i> Form Tambah Kos
                </div>
                ...
                <form action="{{ route('kos.store') }}" method="POST">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="col-12">
                            ...
                            <textarea name="deskripsi"
                                      ...
                                      rows="4"
                                      placeholder="Tuliskan fasilitas dan informasi lengkap kos...">{{ old('deskripsi') }}</textarea>
                            @error('deskripsi')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                    ...
                    <div class="d-flex gap-2 mt-4 pt-3" style="border-top:1px solid #E2E8F0;">
                        <button type="submit" class="btn btn-primary px-4">
                            <i class="bi bi-floppy me-2"></i>Simpan Kos
                        </button>
                        <a href="{{ route('kos.index') }}" class="btn btn-outline-secondary px-4">
                            Batal
                        </a>
                    </div>
                </form>
